...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).foundation(); // TYPING TEXT
// get the element

var text = document.querySelector(".typing-text"); // make a words array

var words = ["Aromatherapists,", "Professors,", "Students,", "Mom's,", "You."]; // start typing effect

setTyper(text, words);

function setTyper(element, words) {
  var LETTER_TYPE_DELAY = 75;
  var WORD_STAY_DELAY = 1500;
...
module.exports = __webpack_require__(/*! C:\Users\Usuario\Projects\Sites\dropsmith\src\assets\js\app.js */"./src/assets/js/app.js");
